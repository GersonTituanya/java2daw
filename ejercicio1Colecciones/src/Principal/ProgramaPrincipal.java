...
public class ProgramaPrincipal {
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            System.out.println("----   Opcion 4 : Obtener el título de los 3 libros con mayor número de páginas.                                    ----");
            ...
            switch (opcion){
                ...
                case 4 :
                    ...
                    obtenerTitulosTresMasPaginas(lista1);

                    break;

                case 5 :

                    System.out.println("Suma total de todas las paginas :"+cantidadMasQuinientos(lista1));
