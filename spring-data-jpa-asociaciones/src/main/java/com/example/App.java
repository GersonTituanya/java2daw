...
public class App {
    ...
    public static void main(String[] args) {
        ...
        Employee employee = new Employee(null,"empl",20,true,40000.0, Instant.now(), LocalDate.now(), LocalDateTime.now(), List.of("email1","email2"), EmployeeType.JUNIOR,address,null,null);
