...
import java.util.*;
import Principal.lista_datos;

import static Principal.lista_datos.*;
/*
    ...
    public static void main(String[] args) {
        ...
        do{
            do{
                ...
                if(lista_datos.anadirTexto) {
                    System.out.println("El texto se anadio corectamente");
                }

            }while(!(texto.substring(texto.length()-4).equals(parar)));

            System.out.println("Quieres escribir otro texto ¿?");
